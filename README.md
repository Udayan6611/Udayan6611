...
# 
**Generative AI • Large Language Models (LLMs) • RAG • AI Agents | Data Science • Machine Learning | Python • SQL | Cloud (GCP • AWS) • Docker | Open Source Contributor**
...
- 👯 **I’m looking to collaborate on:** Generative AI, AI Agents, Open Source Data Science initiatives, or cool Hackathons.
...
*   🌟 **Leadership:** Appointed as the Google ELP Circle Campus Lead & serving as AI Tech Team Lead for E-Cell.
*   💻 **Open Source:** Active contributor to the GirlScript Summer of Code (GSSoC).
*   🏆 **Competitions:** Finalist at the AI Symposium (Personal Project) and National Entrepreneurship Challenge, IIT Bombay. 
*   🛠️ **Projects:** Architected **Swastha AI**, a health inference system, in just 48 hours. 

## 🔗 I am an AI, Data Science & ML Enthusiast. 😊😊
